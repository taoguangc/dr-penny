...
const stories = [
  {
    ...
    content: "我因为感情的问题，先找到Penny做个体咨询。通过个体咨询我了解了我原生家庭严重创伤。我开始疗愈我的原生家庭创伤，同时我做了伴侣咨询来修复关系里的心结和学习亲密关系经营的方法。很开心，我与我妈妈的关系治愈了很多，我妈妈也开始做咨询，学习心理学。我们一家人多在进步。",
  },
  {
    ...
    content: "老公出轨后，我与我老公挣扎痛苦了1年，甚至到达离婚状态。找到 Penny 后, 开启了伴侣咨询，修复创伤之路，重新建立起对他的信任。同时，我们参加了婚姻私教项目，来帮助我解决过去婚姻的问题，和掌握科学经营婚姻的方法。",
  }
]
...
<section class="py-8 sm:py-20">
  <div class="container mx-auto px-4 md:px-16 text-2xl leading-loose">
    <div class="flex flex-col text-center mb-8 sm:mb-20">
      <h2 class="text-primary text-2xl font-bold sm:text-4xl ml-16 pt-2 pb-4 pr-16 sm:pt-3 sm:pb-6 sm:pr-24 bg-contain bg-no-repeat bg-center do-title tracking-wide">我们可以做什么</h2>
    </div>
...
<section class="py-20 bg-secondary">
  <div class="container mx-auto flex flex-col gap-x-24 text-sm sm:text-2xl leading-loose">
    <img src="/images/drpenny.svg" alt="DR.Penny" class="w-48 sm:w-80 mb-2 sm:mb-4">
    <h2 class="col-span-2 text-2xl sm:text-4xl font-bold text-primary tracking-wide mb-8">我的自我疗愈故事</h2>
...
<section class="py-16 sm:py-20">
  <div class="container mx-auto px-4 sm:px-8 text-base lg:text-2xl leading-loose flex flex-col lg:flex-row">
    <div class="flex-1 flex flex-col justify-center items-center">
      <div class="m-16 mb-4 sm:m-8 relative">
        <img src="/images/avatar.webp" alt="Penny 博士" class="absolute rounded-full w-48 sm:w-auto top-6 left-4 sm:top-5 sm:left-4">
...
<section class="py-12 bg-secondary">
  <div class="container mx-auto p-8 md:p-16">
    <h2 class="text-center text-2xl lg:text-5xl font-bold tracking-wide mb-12 sm:mb-24">我们的解决方案</h2>
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 text-2xl">
      {#each solutions as { title, url, details }, i}
      <div class="card w-full h-80 md:h-auto md:aspect-square px-6 py-4 md:p-12">
        <h3 class="font-bold text-xl md:text-3xl xl:text-5xl mb-0 sm:mb-4">0{i+1}</h3>
...
<section class="py-6 sm:py-20">
  <div class="container mx-auto">
    <h2 class="text-center text-2xl lg:text-5xl font-bold tracking-wide mb-8 sm:mb-16">来访进步故事</h2>
    <Modal {video} />
    <div class="mb-16">
            ...
            <div class="basis-7/12">
              <div class="flex flex-row gap-x-4 items-center mb-4 xl:mb-6">
                ...
                <div class="flex flex-col">
                  <h4 class="text-lg sm:text-2xl font-bold">{story.name}</h4>
...
<section class="py-10 sm:py-20 bg-secondary">
  <div class="container mx-auto px-2 text-base lg:text-2xl leading-loose">
    <div class="grid place-items-center">
      <h2 class="text-2xl xl:text-5xl font-bold mb-0 sm:mt-8 sm:mb-12">相信自己，相信Penny博士</h2>
    </div>
